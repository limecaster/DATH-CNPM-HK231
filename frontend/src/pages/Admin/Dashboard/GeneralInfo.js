...
export default function GeneralInfo() {
    const [generalInfo, setgeneralInfo] = useState([{readerCount:0, bookCount:0 , borrowCount:0, givebackCount : 0}]);
    useEffect(() => {
        axios.get('http://localhost:3001/borrow/dashboard/general-info')
            .then(res => {
