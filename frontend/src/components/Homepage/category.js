...
function Category(props) {
    return (
        <div className="card" style={{marginRight: '5%', marginLeft: '5%', boxShadow: '2px 6px 8px 0 rgba(22, 22, 26, 0.18)'}}>
            ...
            <Link to={`/`}>
                <button className="btn btn-success" style={{ width: '100%', textAlign: 'center', color: 'white', fontSize: 14, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word', backgroundColor: '#31AAB7' }}>Xem thêm</button>
            </Link>
        </div>
