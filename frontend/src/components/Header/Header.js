      ...
      <Navbar bg="#ffffff" variant="light" expand="lg" className='border-bottom'>
        <Navbar.Brand href="#home">
          ...
          <span className='d-inline-block align-bottom'>
            <span style={{ color: '#032B91', fontSize: 40, fontFamily: 'Train One', fontWeight: '400', wordWrap: 'break-word' }}>BK</span>
            <span style={{ color: '#1488DB', fontSize: 40, fontFamily: 'Train One', fontWeight: '400', wordWrap: 'break-word' }}>LIB</span>
          </span>
        </Navbar.Brand>
          ...
          <Form inline style={{width: '65%'}}>
            <Row style={{width:'100%'}}>
              ...
              <Col xs="auto" style={{paddingLeft: '0'}}>
                <Button type="submit" className='rounded-0' style={{backgroundColor: '#31AAB7'}}><BsSearch /></Button>
              </Col>
            </Row>
          </Form> 
            <Nav>
              <Nav.Item>
                <Nav.Link href="#home" className='ms-2 me-2'>
                  <span style={{color: '#324552', fontSize: 16.26, fontFamily: 'Work Sans', fontWeight: '400', wordWrap: 'break-word'}}><BsBell/>Thông báo</span>
                </Nav.Link>
              </Nav.Item>
              <Nav.Item>
                <Nav.Link href="#features" className='ms-2 me-2'><span style={{color: '#324552', fontSize: 16.26, fontFamily: 'Work Sans', fontWeight: '400', wordWrap: 'break-word'}}>Đề xuất</span></Nav.Link>
              </Nav.Item>
              <Nav.Item>
              ...
              <Nav.Item>
                ...
                >
                  <Link to='/register'>
                    <span style={{textAlign: 'center', color: '#21717A', fontSize: 16.26, fontFamily: 'Work Sans', fontWeight: '400', wordWrap: 'break-word'}}>Đăng kí</span>
                  </Link>
                </Button>
              </Nav.Item>
            </Nav>  
